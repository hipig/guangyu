<template>
  <ul class="flex items-center space-x-2" v-if="pages > 0">
    <li>
      <button @click="prev" class="py-1 px-3 border rounded" :class="[localPage === 1 ? 'bg-orange-400 border-orange-400 opacity-50 text-white' : 'bg-orange-600 border-orange-600 text-white cursor-pointer']" :disabled="localPage === 1">上一页</button>
    </li>
    ...
    <li>
      <button @click="next" class="py-1 px-3 rounded" :class="[localPage === pages ? 'bg-orange-400 border-orange-400 opacity-50 text-white' : 'bg-orange-600 border-orange-600 text-white cursor-pointer']" :disabled="localPage === pages">下一页</button>
    </li>
  </ul>
</template>
